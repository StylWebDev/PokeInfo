  ...
  <Transition appear enter-from-class="scale-0 opacity-0" appear-active-class="transition-all duration-500 ease-in">
    <StracturesFlex :column="true" justify="center" items="center" class="gap-y-6 z-50">
      <RouterLink to="/pokedex"
                  class=" font-bold text-neutral-800 hover:text-white relative overflow-hidden bg-orange-600 max-[300px]:w-screen sm:w-[400px] md:w-[475px] lg:w-[600px] xl:w-[800px] 2xl:w-[900px] min-[500px]:w-[450px] min-[400px]:w-[350px] min-[300px]:w-[275px] py-7 rounded-xl
      ...
      <RouterLink to="/About"
                  class="font-bold text-neutral-800 hover:text-white  relative overflow-hidden bg-sky-500 max-[300px]:w-screen sm:w-[400px] md:w-[475px] lg:w-[600px] xl:w-[800px] 2xl:w-[900px] min-[500px]:w-[450px] min-[400px]:w-[350px] min-[300px]:w-[275px] py-7 rounded-xl
